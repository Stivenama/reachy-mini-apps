...
- Reachy Mini Hub deriva del desarrollo de Pollen Robotics y conserva su autoría declarada en `apps/reachy_mini_hub/pyproject.toml`. Esta copia incorpora adaptaciones de la instalación del robot; no se presenta todo su contenido como creación original de este proyecto.
