...
from reachy_mini_hub import app_lifecycle
from reachy_mini_hub.utils import (
    parse_args,
    setup_logger,
...
if TYPE_CHECKING:
    from reachy_mini_hub.console import LocalStream
...
def main() -> None:
    ...
    if args.command == "tool-spaces":
        from reachy_mini_hub.tool_spaces import handle_tool_spaces_command
...
def run(
    ...
    from reachy_mini_hub.startup_settings import (
        StartupSettings,
    ...
    from reachy_mini_hub.console import LocalStream
    from reachy_mini_hub.tools.core_tools import ToolDependencies, initialize_tools
    ...
    def build_handler(startup_voice: Optional[str] = None) -> ConversationHandler:
        ...
        from reachy_mini_hub.huggingface_realtime import HuggingFaceRealtimeHandler
    ...
    # Each async service Ã¢â€ â€™ its own thread/loop
    ...
    def poll_stop_event() -> None:
        ...
        "power the robot down" Ã¢â‚¬â€ the daemon returns it to the neutral
...
class ReachyMiniHubApp(ReachyMiniApp):  # type: ignore[misc]
    """Reachy Mini Apps entry point for Reachy Hub (Talk + Timeline + Chat)."""

    custom_app_url = "http://0.0.0.0:7863/"
    dont_start_webserver = False

    def run(self, reachy_mini: ReachyMini, stop_event: threading.Event) -> None:
        """Run the Reachy Hub app."""
